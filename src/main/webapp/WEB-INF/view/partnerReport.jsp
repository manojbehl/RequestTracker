...
<script src="js/partnerReport.js" type="text/javascript" charset="utf-8"></script>
...
<body>
				...
				<div class="navbar-collapse collapse ">
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						<li><a href="partnerDashboard" >Dashboard</a></li>
                             <li><a href="partnerReport" class="menu-top-active">Report</a></li>
	...
	<div class="content-wrapper">
			<div class="container">
			<div class="row">
				<form action="javascript:getConversionOverviewForPartner()">
					<div class="col-md-3">
					...
					<div class="col-md-2" style="display: none">
						...
						<input type="hidden" name="" id="partnerId" value="${userSessionObject.partnerId}"></input>
						<!--  <select id="partnerId"
							class="form-control">
